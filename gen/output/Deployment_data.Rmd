...
Furthermore, Table 2 and 3 show that the minimum amounts of nights that you need to rent the listing, has an extremely different effect on the price of the listing. Before and after the festival, the price of the listings gets lower when the minimum amounts of nights is higher, while during the festival this is the opposite. 
...
Lastly, a linear regression is shown with the influence of the number of reviews, the minimum nights, the room type and the neighborhood group on the price of the listings during the festival (Table 4). The base model of the linear regression is an entire home/apt and a listing in the neighbourhood group Ciutat VellaThis. Thislinear regression gives a model that can be used by Airbnb hosts to define the pricing of their listings during Primevera Sound. 
...
knitr::kable(regression_summary4, format = "markdown", digits = 4, caption = "Influece of number of reviews, minimum nights, room type and neighborhood group on price during the festival")
